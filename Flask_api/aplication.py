...
app.add_url_rule("/api/user_followers/", view_func=user_follows_get, methods=['GET',], defaults={'username': None})
app.add_url_rule("/api/user_followers/<username>", view_func=user_follows_get, methods=['GET',])
################

user_following_jwt = jwt_required(UserFollowing.as_view("user_following_jwt"))
app.add_url_rule("/api/user_following/", view_func=user_following_jwt, methods=['GET',], defaults={'username': None})
app.add_url_rule("/api/user_following/<username>", view_func=user_following_jwt, methods=['GET'])
app.add_url_rule("/api/user_following/<user_to_follow>", view_func=user_following_jwt, methods=['POST'])
################
